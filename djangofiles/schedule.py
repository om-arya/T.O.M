...
def generate_schedule(EVENTS, ADDITIONAL_NOTES):
  prompt = (
        ...
        "You must include breakfast, lunch, and dinner. Every event will take exactly as long as specified by the user, and you will display ranges in the format of 0:00 AM/PM - 0:00 AM/PM."
